...
#define sprite_index_shots_first 0
#define sprite_index_shots_count 16
#define sprite_index_shots_last 15
#define sprite_palette_shots 0
#define sprite_size_shots 2
#define sprite_pixelsize_shots 8
#define sprite_halfpixelsize_shots 4
#define sprite_index_trails_first 16
#define sprite_index_trails_count 4
#define sprite_index_trails_last 19
#define sprite_palette_trails 0
